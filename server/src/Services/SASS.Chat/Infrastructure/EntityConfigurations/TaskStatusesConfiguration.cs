...
public sealed class TaskStatusesConfiguration : IEntityTypeConfiguration<ProjectTaskStatus>
{
    public void Configure(EntityTypeBuilder<ProjectTaskStatus> builder)
    {
        ...
        builder.HasData(
            new { Id = new Guid("54a3f5eb-3c1b-4aa6-9154-ee9164e65862"), Name = "Todo", Order = 1  },
            new { Id = new Guid("ce0b6071-db6d-4820-8a69-095322ccbe3d"), Name = "InProgress", Order = 2 },
            new { Id = new Guid("02B1EE43-E224-495C-A2CB-53684B30BCB2"), Name = "Review", Order = 3 },
            new { Id = new Guid("853bac26-1dc9-4662-8658-6864faa1a9ca"), Name = "Done", Order = 4 }
        );
    }
}
