...
namespace SASS.Chat.Infrastructure.Migrations
{
    ...
    [Migration("20260607040103_AddTaskMetadataKeys")]
    partial class AddTaskMetadataKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SASS.Chat.Domain.AggregatesModel.Projects.TaskType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Order")
                        .IsUnique()
                        .HasDatabaseName("ix_task_types_order");
            ...
            modelBuilder.Entity("SASS.Chat.Domain.AggregatesModel.Projects.Task", b =>
                {
                    ...
                    b.HasOne("SASS.Chat.Domain.AggregatesModel.Projects.TaskType", "Type")
                        .WithMany()
