...
namespace SASS.Chat.Infrastructure.Migrations
{
    ...
    [Migration("20260507144210_UpdateMessageTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SASS.Chat.Domain.AggregatesModel.Conversations.ConversationMember", b =>
                {
                    b.Property<Guid>("ConversationId")
                        .HasColumnType("uuid")
                        .HasColumnName("conversation_id");
                    ...
                    b.HasIndex("MemberId")
                        .HasDatabaseName("ix_conversation_members_member_id");
            ...
            modelBuilder.Entity("SASS.Chat.Domain.AggregatesModel.Projects.TaskPriority", b =>
                {
                    ...
                    b.HasIndex("Order")
                        .IsUnique()
                        .HasDatabaseName("ix_task_priorities_order");
            ...
            modelBuilder.Entity("SASS.Chat.Domain.AggregatesModel.Projects.TaskStatus", b =>
                {
                    ...
                    b.HasIndex("Order")
                        .IsUnique()
                        .HasDatabaseName("ix_task_statuses_order");
            ...
            modelBuilder.Entity("SASS.Chat.Domain.AggregatesModel.Conversations.ConversationMember", b =>
                {
                    b.HasOne("SASS.Chat.Domain.AggregatesModel.Conversations.Conversation", null)
                    ...
                    b.HasOne("SASS.Chat.Domain.AggregatesModel.Users.User", null)
                        .WithMany()
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_conversation_members_users_member_id");
                });
            ...
            modelBuilder.Entity("SASS.Chat.Domain.AggregatesModel.Conversations.Message", b =>
                {
                    ...
                    b.HasOne("SASS.Chat.Domain.AggregatesModel.Users.User", "Sender")
                        .WithMany()
